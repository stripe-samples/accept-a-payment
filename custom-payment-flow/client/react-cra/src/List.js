...
const List = () => {
  return (
    <>
      ...
      <ul>
        <li>
          <a href="/ach-debit">ACH Direct Debit (TODO: Sources)</a>
        </li>
        <li>
          <a href="/bacs-debit">Bacs Direct Debit (TODO: Requires Checkout)</a>
        </li>
        <li>
      ...
      <ul>
        <li>
          <a href="/bancontact">Bancontact</a>
        </li>
        <li>
          <a href="/eps">EPS</a>
        </li>
        ...
        <li>
          <a href="/giropay">giropay</a>
        </li>
        <li>
          <a href="/ideal">iDEAL</a>
        </li>
        <li>
          <a href="/p24">Przelewy24 (P24)</a>
        </li>
        <li>
          <a href="/sofort">Sofort</a>
        </li>
      </ul>
      ...
      <ul>
        <li>
          <a href="/ach-credit">ACH Credit</a>
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          <a href="/grabpay">GrabPay</a>
        </li>
        <li>
          <a href="/microsoft-pay">Microsoft Pay</a>
        </li>
        <li>
          <a href="/wechat-pay">WeChat Pay</a>
        </li>
      </ul>
    </>
  );
